...
# Generated by qmake (2.01a) (Qt 4.7.4) on: ven. avr. 27 00:03:58 2012
...
LINK          = g++
LFLAGS        = -m64 -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/x86_64-linux-gnu -ljack -lsndfile -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: qjackrcd.pro  /usr/share/qt4/mkspecs/linux-g++-64/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
		/usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/qconfig.pri \
		/usr/share/qt4/mkspecs/modules/qt_webkit_version.pri \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/qjackrcd1.0.4/ && $(COPY_FILE) --parents qjackrcd_en.ts qjackrcd_fr.ts qjackrcd_it.ts qjackrcd_cs.ts qjackrcd_de.ts build/qjackrcd1.0.4/ && $(COPY_FILE) --parents mainwindow.h recorder.h qjrmeter.h build/qjackrcd1.0.4/ && $(COPY_FILE) --parents qjackrcd.qrc build/qjackrcd1.0.4/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp recorder.cpp qjrmeter.cpp build/qjackrcd1.0.4/ && $(COPY_FILE) --parents mainwindow.ui build/qjackrcd1.0.4/ && $(COPY_FILE) --parents qjackrcd_en.ts qjackrcd_fr.ts qjackrcd_it.ts qjackrcd_cs.ts qjackrcd_de.ts build/qjackrcd1.0.4/ && (cd `dirname build/qjackrcd1.0.4` && $(TAR) qjackrcd1.0.4.tar qjackrcd1.0.4 && $(COMPRESS) qjackrcd1.0.4.tar) && $(MOVE) `dirname build/qjackrcd1.0.4`/qjackrcd1.0.4.tar.gz . && $(DEL_FILE) -r build/qjackrcd1.0.4
...
locale/qjackrcd_de.qm: qjackrcd_de.ts
	/usr/bin/lrelease qjackrcd_de.ts -qm locale/qjackrcd_de.qm
