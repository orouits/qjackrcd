...
# Generated by qmake (2.01a) (Qt 4.7.2) on: mer. août 24 23:25:33 2011
# Project:  qjackrcd.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile qjackrcd.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib -ljack -lsndfile -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
