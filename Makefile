...
# Generated by qmake (2.01a) (Qt 4.7.4) on: sam. déc. 10 01:36:34 2011
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/qjackrcd1.0.0/ && $(COPY_FILE) --parents mainwindow.h recorder.h qjrmeter.h .tmp/qjackrcd1.0.0/ && $(COPY_FILE) --parents qjackrcd.qrc .tmp/qjackrcd1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp recorder.cpp qjrmeter.cpp .tmp/qjackrcd1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/qjackrcd1.0.0/ && $(COPY_FILE) --parents qjackrcd_en.ts qjackrcd_fr.ts qjackrcd_it.ts .tmp/qjackrcd1.0.0/ && (cd `dirname .tmp/qjackrcd1.0.0` && $(TAR) qjackrcd1.0.0.tar qjackrcd1.0.0 && $(COMPRESS) qjackrcd1.0.0.tar) && $(MOVE) `dirname .tmp/qjackrcd1.0.0`/qjackrcd1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/qjackrcd1.0.0
